...
const InProgressTasks = () => {
            ...
            for (let i in dataValues) {
                if (dataValues[i] == undefined) {
                    ...
                    for (let j = 0; j < dataValues[i].length; j++) {
                        if (dataValues[i][j].is_complete == 1) {
                            inprogressArray.push(dataValues[i][j]);
                        }
                    }
                }                
            }
    ...
    function pendingTasks() {     
        ...
        .then((data) => {
            ...
            console.log('progress', inprogressArray.length);
            console.log('update', updateTasksArray.length);
            if (inprogressArray.length != updateTasksArray.length) {
                setLoading(true);
                pendingTasksArray.length = 0;
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.taskContainer}>
                ...
                {(loading == false && inprogressArray.length == 0) &&
                ...
                {(loading == false && inprogressArray.length != 0) &&
                    ...
                    {
                        inprogressArray.map((task, index) => (
